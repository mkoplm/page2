...
public class MainView {
	...
	public static void main(String[] args) {
		...
		CustomerController.insert(new MediaDTO(1000,"야생화","박효신",1,500,19));
		CustomerController.insert(new MediaDTO(1001,"그런 남자","Bro",1,300,19));
		CustomerController.insert(new MediaDTO(1002,"썸(Feat.릴보이 Of 긱스)","소유,정기고",1,600,19));
...
//		Controller.insert(new CustomerDTO("custemer09","유병찬",27,1000,2009));
		...
		CustomerController.getMediaAll();
		System.out.println();
		...
		CustomerController.getCustomer("custemer02");
		CustomerController.getMedia(1002);
		
		System.out.println("******************** 음원 정보 삭제 후 조회(1001) ********************");
		CustomerController.delete(1001);
		CustomerController.getMediaAll();
	}
}
